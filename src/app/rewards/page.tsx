...
const TEXT = {
  ...
  fr: {
    ...
    receiverPlaceholder: "E-mail du destinataire",
    ...
    userNotFoundError: "Utilisateur destinataire non trouvé.",
  ...
  es: {
    ...
    receiverPlaceholder: "Correo del destinatario",
    ...
    userNotFoundError: "Usuario receptor no encontrado.",
  ...
  pt: {
    ...
    receiverPlaceholder: "E-mail do destinatário",
    ...
    userNotFoundError: "Usuário destinatário não encontrado.",
